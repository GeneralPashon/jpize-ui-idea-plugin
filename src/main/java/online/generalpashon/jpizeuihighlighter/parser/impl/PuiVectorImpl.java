...
public class PuiVectorImpl extends ASTWrapperPsiElement implements PuiVector {

  public PuiVectorImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PuiSingleValue> getSingleValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PuiSingleValue.class);
  }
