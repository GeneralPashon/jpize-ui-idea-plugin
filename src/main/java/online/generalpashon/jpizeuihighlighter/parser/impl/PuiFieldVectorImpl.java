...
public class PuiFieldVectorImpl extends ASTWrapperPsiElement implements PuiFieldVector {

  public PuiFieldVectorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PuiVisitor visitor) {
    visitor.visitFieldVector(this);
  }
